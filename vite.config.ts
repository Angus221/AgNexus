...
export default defineConfig({
  plugins: [
    react(),
    // tsconfigPaths(), // 移除，使用下面的显式 alias 配置
    tailwindcss(),
    {
  ...
  resolve: {
    alias: {
      ...
      "@features": resolve(__dirname, "src/sidepanel/features"),
      "@services": resolve(__dirname, "src/sidepanel/services"),
      "@contexts": resolve(__dirname, "src/sidepanel/contexts"),
